  ...
  return (
    <div>
      ...
      <div className="stats-grid" style={{ marginBottom: 24 }}>
        ...
        <StatCard title={"TVL " + (t0?.symbol ?? "T0")} value={pool ? formatNumber(parseFloat(pool.reserve0)) + " " + (t0?.symbol ?? "") : ""} loading={poolLoading} />
        <StatCard title={"TVL " + (t1?.symbol ?? "T1")} value={pool ? formatNumber(parseFloat(pool.reserve1)) + " " + (t1?.symbol ?? "") : ""} loading={poolLoading} />
      </div>
